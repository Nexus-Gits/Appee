...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '6cfa275818464da29f06059b14559c34',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AppEE', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'EE Department App', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://appee.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, ee', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'AppEE', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'EE Department App', // 站点描述，被notion中的页面描述覆盖
